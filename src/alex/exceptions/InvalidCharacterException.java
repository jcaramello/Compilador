...
public class InvalidCharacterException extends ALexException {
	...
	private static String messageWithAdditionalInfo = "%s no es un caracter válido. %s :: Línea: %d";
	...
	public InvalidCharacterException(String lexema, String additionalInfo,int line) {
		super(String.format(messageWithAdditionalInfo, lexema, additionalInfo,line));
	}
}
